...
import 'package:todo/feature/task/presentation/widget/task_page_app_bar.dart';
...
class _TaskPageState extends State<TaskPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TaskPageAppBar(task: widget.task,),
      body: SizedBox(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ReuseableText(
                          title: formatDateTime(widget.task.createdAtDate, includeTime: true),
                          style: TextStyle(
